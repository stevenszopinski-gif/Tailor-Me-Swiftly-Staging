...
async function run() {
    ...
    await page.evaluate(() => {
        const mockResume = `
            <h1 style="font-size:1.6rem;margin:0 0 0.2rem;color:var(--r-accent,#10b981);">Steven Szopinski</h1>
            <p style="font-size:0.82rem;color:#666;margin:0 0 0.75rem;">San Francisco, CA &bull; steven@email.com &bull; (555) 123-4567 &bull; linkedin.com/in/stevenszopinski</p>
        ...
        sessionStorage.setItem('tms_outputs', JSON.stringify({ resumeHtml: mockResume, applicantName: 'Steven Szopinski' }));
    });
